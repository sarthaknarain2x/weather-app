...
const apiKey = '79e63920a67d5f1681f151da67ebbea3';
...
const App = () => {
  ...
  switch (data.weather[0].main) {
    ...
    case 'Thunderstorm':
      icon = <IoMdThunderstorm className='text-[#72848a]' />;
      break;
  }
  ...
  return (
    <div className='w-full  bg-gradientBg bg-no-repeat bg-cover bg-center flex flex-col items-center justify-center px-4 py-20 lg:px-0'>
      ...
      <form className={`${animate ? 'animate-shake' : 'animate-none'} h-16 bg-black/30 w-full max-w-[450px] rounded-full backdrop-blur-[32px] mb-8`}>
        <div className='h-full relative flex items-center justify-between p-2'>
          <input onChange={(e) => handleInput(e)} className='flex-1 bg-transparent outline-none placeholder: text-white text-[15px] font-light pl-6 h-full' type="text" placeholder='Search by city or country' />
